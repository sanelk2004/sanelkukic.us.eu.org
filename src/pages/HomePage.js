...
const HomePage = (props) => {
    return (
        <Container className="mt-3">
            ...
            <a href="https://twitter.com/idkhow_to_read" target="_blank" rel="noreferrer"><FontAwesomeIcon size="2x" icon={faTwitter}/></a>
            <a href="https://instagram.com/sanelk2004" target="_blank" rel="noreferrer"><FontAwesomeIcon size="2x" icon={faInstagram}/></a>
            <a href="https://news.ycombinator.com/user?id=sanelkukic" target="_blank" rel="noreferrer"><FontAwesomeIcon size="2x" icon={faHackerNews}/></a>
            ...
            <a href="https://reddit.com/u/idkhow_to_read" target="_blank" rel="noreferrer"><FontAwesomeIcon size="2x" icon={faReddit}/></a>
